...
public class QuestionSendActivity extends AppCompatActivity
    ...
    public void onClick(View v) {
        if (v == mImageView) {
            ...
            DatabaseReference genreRef =
                    databaseReference.child(Const.ContentsPATH).child(String.valueOf(mGenre));
    ...
    private void showChooser() {
        ...
        // EXTRA_INITIAL_INTENTにカメラ撮影のIntentを追加
